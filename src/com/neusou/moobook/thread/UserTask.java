...
//    protected static int KEEP_ALIVE = 1;//careful when setting this value. since it is coupled with SystemClock.wait.
//    protected static TimeUnit KEEP_ALIVE_UNIT = TimeUnit.SECONDS;
//
//    public static abstract interface IUserTaskListener<P,R>{
...
//        
//    private IUserTaskListener<Progress, Result> mUserTaskListener;
//    
//    private long mTimeoutMilliseconds = 1;
//    
//    /**
...
//        if(mUserTaskListener != null){
//    		mUserTaskListener.onPostExecute(result);
//    	}
